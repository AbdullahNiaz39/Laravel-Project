@extends('layout')
@section('main')
<!-- <form action="/admin/informs" method="post"> 

<input type="text" placeholder="Enter the Name" name="name"><br>
<input type="email" placeholder="Enter phone number" name="email"><br>
<input type="message" placeholder="message" name="message"><br>
...
<body>
	...
	<div class="container-contact100">
		<div class="contact100-map" id="google_map" data-map-x="40.722047" data-map-y="-73.986422" data-pin="/contact/images/icons/map-marker.png" data-scrollwhell="0" data-draggable="1"></div>

		<div class="wrap-contact100">
			<div class="contact100-form-title" style="background-image: url(/contact/images/bg-01.jpg);">
			...
			<form class="contact100-form validate-form" action="/admin/informs" method="post">
